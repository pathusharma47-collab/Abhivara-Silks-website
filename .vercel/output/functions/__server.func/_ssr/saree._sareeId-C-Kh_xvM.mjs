...
import { n as saree1_default, r as saree2_default, t as SiteNav } from "./SiteNav-BrzCYnEt.mjs";
import { t as Route } from "./saree._sareeId-BCB4J6fN.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/saree._sareeId-C-Kh_xvM.js
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
							className: "mt-4 text-4xl md:text-5xl font-serif text-[var(--foreground)] leading-[1.1]",
							children: title
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
