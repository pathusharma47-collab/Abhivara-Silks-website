...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Abivara Silks: a quiet-luxury house of handwoven Indian silks. Kanchipuram, Banarasi, Organza and heritage weaves, curated for the modern woman." },
      { name: "author", content: "Abivara Silks" },
      { property: "og:title", content: "Abivara Silks" },
      { property: "og:description", content: "Crafted Heritage. Woven Elegance." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@AbivaraSilks" },
    ],
    links: [
